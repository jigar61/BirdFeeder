export class Renderer {
    static drawHawk(ctx, x, y, frame, size) {
        ctx.save();
        ctx.translate(x, y);
    ...
    static drawDove(ctx, x, y, frame, size) {
        ctx.save();
        ctx.translate(x, y);
        const wingAngle = (frame / 3) * Math.PI * 2;
        const wingUp = Math.sin(wingAngle);
    ...
    static drawSparrow(ctx, x, y, frame, size) {
        ctx.save();
        ctx.translate(x, y);
        const wingAngle = (frame / 3) * Math.PI * 2;
        const wingUp = Math.sin(wingAngle);
    ...
    static drawChickadee(ctx, x, y, frame, size) {
        ctx.save();
        ctx.translate(x, y);
        const wingAngle = (frame / 3) * Math.PI * 2;
        const wingUp = Math.sin(wingAngle);
    ...
    static drawCrow(ctx, x, y, frame, size) {
        ctx.save();
        ctx.translate(x, y);
        const wingAngle = (frame / 3) * Math.PI * 2;
        const wingUp = Math.sin(wingAngle);
    ...
    static drawSquirrel(ctx, x, y, frame, size) {
        ctx.save();
        ctx.translate(x, y);
    ...
    static drawCat(ctx, x, y, frame, size) {
        ctx.save();
        ctx.translate(x, y);
        const legOffset = Math.sin(frame * Math.PI / 2) * size * 0.15;
    ...
    static drawBird(ctx, x, y, frame, type, size) {
        switch (type) {
            case 'hawk':
                this.drawHawk(ctx, x, y, frame, size);
                break;
            case 'dove':
                this.drawDove(ctx, x, y, frame, size);
                break;
            case 'sparrow':
                this.drawSparrow(ctx, x, y, frame, size);
                break;
            case 'chickadee':
                this.drawChickadee(ctx, x, y, frame, size);
                break;
            case 'crow':
                this.drawCrow(ctx, x, y, frame, size);
                break;
            case 'squirrel':
                this.drawSquirrel(ctx, x, y, frame, size);
                break;
            case 'cat':
                this.drawCat(ctx, x, y, frame, size);
                break;
        }
    }
    ...
    static drawSnake(ctx, x, y, frame, size) {
        ctx.save();
        ctx.translate(x, y);
    ...
    static drawRat(ctx, x, y, frame, size) {
        ctx.save();
        ctx.translate(x, y);
        // Body (oval, centered)
    ...
    static drawEnvironment(ctx, w, h, backgroundColor, grassColor) {
        // Sky/background
